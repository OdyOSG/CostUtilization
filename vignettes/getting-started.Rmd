...
# Perform micro-costing analysis
...
For more detailed analysis, request the list format output:
...
diagPlot <- detailedResults$diagnostics |>
  ...
  ggplot(aes(x = step_name, y = n_persons)) +
